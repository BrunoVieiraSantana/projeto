...
class PieGasto(MDBoxLayout):
    ...
    def plot_pie(self):
        ...
        ax.pie(list_values, wedgeprops=dict(width=0.2), autopct='%1.1f%%', colors=colors, shadow=True, startangle=90)
        ax.legend(list_category, labelcolor='#ffffff', loc="center left", edgecolor="#455a64",
                  facecolor='#607d8b', bbox_to_anchor=(0.35, 0.17), bbox_transform=fig.transFigure, framealpha=0)
